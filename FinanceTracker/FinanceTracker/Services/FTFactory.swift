...
final class FTFactory {
    ...
    func createBadgetsView(dataManager: some DataManagerProtocol, delegate: (some BudgetsViewModelDelegate)? = nil, actionWithViewModel: ((BudgetsViewModel) -> Void)? = nil) -> AnyView {
